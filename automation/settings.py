...
print("LOCAL_SECRET_BASE_URL:", os.environ.get('LOCAL_SECRET_BASE_URL'))
print("SIGATURE_SECRET:", os.environ.get('SIGATURE_SECRET'))
# After defining LS_BACKEND_API_KEY and LS_BACKEND_SETTINGS
print("LS_BACKEND_API_KEY:", LS_BACKEND_API_KEY)
print("LS_BACKEND_SETTINGS:", LS_BACKEND_SETTINGS)
