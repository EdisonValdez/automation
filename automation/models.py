...
class Business(models.Model):
    ...
    city = models.CharField(max_length=100, blank=True)  # Can be overridden by form input
    state = models.CharField(max_length=100, blank=True)
    postal_code = models.CharField(max_length=20, blank=True)
    country = models.CharField(max_length=100, blank=True)  # Can be overridden by form input
